...
# meta developer: @hikarimods | modified by @the_farkhodov 
# scope: hikka_only
# scope: nino_min 3.2.2
# requires: requests
...
class ScrolllerMod(loader.Module):
    ...
    async def gallerynudescmd(self, message: Message):
    ...
    async def gallerynsfwcmd(self, message: Message):
